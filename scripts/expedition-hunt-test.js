...
(async()=>{try{
  const hz=await ready(); if(hz.version!=='5.5.0')throw Error(`wrong API version ${hz.version}`); if(hz.deployId!=='RIFT-V550-STATUS-COMMAND-RESUME-20260915')throw Error(`wrong deploy id ${hz.deployId}`);
