...
(async()=>{try{
  const hz=await ready(); if(hz.version!=='5.4.0')throw Error(`wrong API version ${hz.version}`); if(hz.deployId!=='RIFT-V540-SIGNATURE-TACTIC-PACING-20260915')throw Error(`wrong deploy id ${hz.deployId}`);
