...
(async()=>{try{
  const hz=await ready(); if(hz.version!=='4.2.0')throw Error(`wrong API version ${hz.version}`); if(hz.deployId!=='RIFT-V52-CLASSIC-BATTLE-20260915')throw Error(`wrong deploy id ${hz.deployId}`);
