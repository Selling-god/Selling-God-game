...
(async()=>{try{
  const hz=await ready(); if(hz.version!=='5.3.2')throw Error(`wrong API version ${hz.version}`); if(hz.deployId!=='RIFT-V532-BATTLEFLOW-RESUME-FX-20260915')throw Error(`wrong deploy id ${hz.deployId}`);
