...
const mustApp=['battle-stage-v31','visual-card-v31','signatureImpactFx','signatureProjectileFx','signatureSummonFx','route-glyph-v31','reward-options-v51','event-visual-card-v31'];
...
console.log('VISUAL_FIRST_OK elements=12 oneScreen=true simplifiedRewardV51=true condensedCards=true signatureVfx=true');
