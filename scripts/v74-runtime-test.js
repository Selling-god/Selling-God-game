...
(async()=>{try{
 ...
 const hz=await ready();assert(hz.version==='7.4.0','health version');assert(hz.deployId==='FUSEWILD-V740-QA-REFRESH-20260918','health deploy');assert(hz.monsters===205,'monster count');
