...
function staticChecks(){
  if(pkg.name!=='fusewild-monster-fusion-roguelite'||pkg.version!=='6.0.0')throw Error('package brand/version');
...
(async()=>{try{
  proc=spawn();const hz=await ready();if(hz.version!=='6.0.0'||hz.deployId!=='FUSEWILD-V600-ROGUE-CADENCE-FUSION-20260916')throw Error(`health ${hz.version}/${hz.deployId}`);
