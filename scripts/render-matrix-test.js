...
if(failures.length){console.error('[KX RENDER MATRIX V12] FAILED');for(const f of failures)console.error(' - '+f);process.exit(1)}
console.log('[KX RENDER MATRIX V12] PASS');
