...
for(const token of ["9.0.0-STEAM-RELEASE-PREP","function kxConfirm(","function kxAlert(","function renderStrategicBrief(","function renderCompanyReturnBriefing(","function renderRivalSnapshot(","data-return-brief-dismiss"])need(app.includes(token),`app missing ${token}`);
...
console.log('[KX STEAM SMOKE] PASS');console.log(' - custom decision UI');console.log(' - concise CEO home + strategic phase');console.log(' - return briefing');console.log(' - relevant rival intelligence');console.log(' - no native browser dialogs');
