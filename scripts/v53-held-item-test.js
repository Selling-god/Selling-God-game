...
(async()=>{try{
 const hz=await ready();if(hz.version!=='5.3.1'||hz.deployId!=='RIFT-V531-RUNMOD-HOTFIX-20260915')throw Error(`health ${hz.version}/${hz.deployId}`);if(hz.items<128)throw Error(`items ${hz.items}`);
