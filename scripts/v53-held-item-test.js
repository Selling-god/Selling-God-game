...
(async()=>{try{
 const hz=await ready();if(hz.version!=='5.5.0'||hz.deployId!=='RIFT-V550-STATUS-COMMAND-RESUME-20260915')throw Error(`health ${hz.version}/${hz.deployId}`);if(hz.items<128)throw Error(`items ${hz.items}`);
