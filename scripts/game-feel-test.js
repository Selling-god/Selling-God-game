...
if(all.length!==55)throw Error(`expected 55 creatures, got ${all.length}`);
...
if(hashes.size<52)throw Error(`creature sprite diversity too low: ${hashes.size}/55 unique`);
