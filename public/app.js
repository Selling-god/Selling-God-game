...
(() => {
  ...
  function renderReward(r){
    ...
    const support=rw.kind==='battle'&&!capturePending?fieldServiceHtml(r,run):'';
    setScreen('reward',`<section class="run-stage-v31 reward-stage-v31 reward-v41 reward-v42"><div class="run-bg-v31" style="background-image:url('${esc(sceneBg(r))}')"></div><div class="ambient-grid-v31"></div><div class="run-shade-v31"></div>${compactRunHud(r,run)}<main class="reward-center-v31"><div class="reward-focus-v31"><div class="reward-step-v31">${esc(step)}</div>${body}${support}${actions}</div></main></section>`);
  }
